...
if os.path.exists(best_model_file):
    ...
    print("best_model.h5 文件不存在，不需要删除。")
...
def fetch_data(lot_code, date, data_dir):
    url = f'https://api.api68.com/pks/getPksHistoryList.do?lotCode={lot_code}&date={date}'
...
def main():
    ...
    print("预测结果：")
    for i, (index, p) in enumerate(predictions):
